...
public class CreateJobBeanMapper {
	...
	public static CreateJobPayload mapper(CreateJobBean bean) {
		...
		return new CreateJobPayload(mstServiceLocationId, mstPlatformId, mstWarrentyStatusId, mstOemId, customer, customerAddress, customerProduct, problemsList);
	}
}