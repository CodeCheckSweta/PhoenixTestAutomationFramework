...
public class CreateJobAPITest {
	...
	public void createJobAPITest() {
		...
		CustomerProduct customerProduct = new CustomerProduct(getTimeWithDaysAgo(10), "44787151381711", "44787151381711", "44787151381711", getTimeWithDaysAgo(10), 1, 1);
		...
		given().spec(requestSpecWithAuth(FD,createJobPayload))
			.when()
			.post("/job/create")
			.then()
